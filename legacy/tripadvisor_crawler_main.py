...
if __name__ == '__main__':
    ...
    output_path_template = "data/hotels_by_city_2/{0}/{0}_shard_{1}.xlsx"
    # path_template = "data/test/{0}_shard_{1}.xlsx"
    reviewer_path = 'data/reviewer_data/Tripadvisor_reviewer_path_ONLY.xlsx'
    ...
    for city in cities[5:]:
        ...
        for i in xrange(start, 1000):
            try:
                ...
                output_path = output_path_template.format(city, i)
